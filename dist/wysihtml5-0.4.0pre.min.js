...
(b=document.createRange(),r(b,u)&&v(b,m)&&(d=!0),b.detach());(b=c(document,"body")?document.body:document.getElementsByTagName("body")[0])&&a(b,"createTextRange")&&(b=b.createTextRange(),e(b)&&(l=!0));d||l||f("Neither Range nor TextRange are implemented");t.initialized=!0;t.features={implementsDomRange:d,implementsTextRange:l};d=B.concat(x);l=0;for(b=d.length;l<b;++l)try{d[l](t)}catch(h){c(window,"console")&&a(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
...
t.fail=f;t.warn=function(a){a="Rangy warning: "+a;t.config.alertOnWarn?window.alert(a):typeof window.console!=p&&typeof window.console.log!=p&&window.console.log(a)};({}).hasOwnProperty?t.util.extend=function(a,b){for(var d in b)b.hasOwnProperty(d)&&(a[d]=b[d])}:f("hasOwnProperty not supported");var x=[],B=[];t.init=g;t.addInitListener=function(a){t.initialized?a(t):x.push(a)};var A=[];t.addCreateMissingNativeApiListener=function(a){A.push(a)};t.createMissingNativeApi=function(a){a=a||window;g();
for(var b=0,d=A.length;b<d;++b)A[b](a)};k.prototype.fail=function(a){this.initialized=!0;this.supported=!1;throw Error("Module '"+this.name+"' failed to load: "+a);};k.prototype.warn=function(a){t.warn("Module "+this.name+": "+a)};k.prototype.createError=function(a){return Error("Error in Rangy "+this.name+" module: "+a)};t.createModule=function(a,b){var d=new k(a);t.modules[a]=d;B.push(function(a){b(a,d);d.initialized=!0;d.supported=!0})};t.requireModules=function(a){for(var b=0,d=a.length,c,e;b<
d;++b){e=a[b];c=t.modules[e];if(!(c&&c instanceof k))throw Error("Module '"+e+"' not found");if(!c.supported)throw Error("Module '"+e+"' not supported");}};var F=!1,s=function(a){F||(F=!0,t.initialized||g())};if(typeof window==p)f("No window found");else if(typeof document==p)f("No document found");else return a(document,"addEventListener")&&document.addEventListener("DOMContentLoaded",s,!1),a(window,"addEventListener")?window.addEventListener("load",s,!1):a(window,"attachEvent")?window.attachEvent("onload",
...
for(c=c.firstChild;c;){if(c===a)return-1;if(c===l)return 1;c=c.nextSibling}throw Error("Should not be here!");},inspectNode:h,fragmentFromNodeChildren:function(a){for(var b=k(a).createDocumentFragment(),c;c=a.firstChild;)b.appendChild(c);return b},createIterator:function(a){return new l(a)},DomPosition:p};a.DOMException=m});
rangy.createModule("DomRange",function(a,c){function b(a,b){return 3!=a.nodeType&&(n.isAncestorOf(a,b.startContainer,!0)||n.isAncestorOf(a,b.endContainer,!0))}function d(a){return n.getDocument(a.startContainer)}function e(a,b,c){if(b=a._listeners[b])for(var d=0,e=b.length;d<e;++d)b[d].call(a,{target:a,args:c})}function f(a){return new L(a.parentNode,n.getNodeIndex(a))}function g(a){return new L(a.parentNode,n.getNodeIndex(a)+1)}function k(a,b,c){var d=11==a.nodeType?a.firstChild:a;n.isCharacterDataNode(b)?
...
t(a,!0);d(this,a,0,a,n.getNodeLength(a))},selectNode:function(a){x(this);t(a,!1);B(a,K);var b=f(a);a=g(a);d(this,b.node,b.offset,a.node,a.offset)},extractContents:N(m,d),deleteContents:N(p,d),canSurroundContents:function(){z(this);y(this.startContainer);y(this.endContainer);var a=new q(this,!0),c=a._first&&b(a._first,this)||a._last&&b(a._last,this);a.detach();return!c},detach:function(){e(this)},splitBoundaries:function(){z(this);var a=this.startContainer,b=this.startOffset,c=this.endContainer,e=
...
l;H(a);e(a,"boundarychange",{startMoved:h,endMoved:f})}function E(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};H(this)}a.requireModules(["DomUtil"]);var n=a.dom,L=n.DomPosition,G=a.DOMException;q.prototype={_current:null,_next:null,_first:null,_last:null,isSingleCharacterDataNode:!1,reset:function(){this._current=null;this._next=this._first},hasNext:function(){return!!this._next},next:function(){var a=this._current=
...
"Offset"],b[d+"Container"],b[d+"Offset"])},insertNode:function(a){z(this);B(a,ga);y(this.startContainer);if(n.isAncestorOf(a,this.startContainer,!0))throw new G("HIERARCHY_REQUEST_ERR");a=k(a,this.startContainer,this.startOffset);this.setStartBefore(a)},cloneContents:function(){z(this);var a,b;if(this.collapsed)return d(this).createDocumentFragment();if(this.startContainer===this.endContainer&&n.isCharacterDataNode(this.startContainer))return a=this.startContainer.cloneNode(!0),a.data=a.data.slice(this.startOffset,
...
d=new B(a.focusNode,a.focusOffset),e="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var h=0,l=a.rangeCount;h<l;++h)b[h]=v.inspect(a.getRangeAt(h));return"["+e+"(Ranges: "+b.join(", ")+")(anchor: "+c.inspect()+", focus: "+d.inspect()+"]"}a.requireModules(["DomUtil","DomRange","WrappedRange"]);a.config.checkSelectionRanges=!0;var r=a.dom,s=a.util,v=a.DomRange,t=a.WrappedRange,x=a.DOMException,B=r.DomPosition,A,F,y=a.util.isHostMethod(window,"getSelection"),
...
v.getRangeDocument(c),d=a.createRange(d);d.collapseToPoint(c.endContainer,c.endOffset);b.nativeSelection.addRange(g(d));b.nativeSelection.extend(c.startContainer,c.startOffset);b.refresh()};w.addRange=P?function(b,c){if(H&&C&&"Control"==this.docSelection.type)p(this,b);else if(c&&M)n(this,b);else{var d;N?d=this.rangeCount:(this.removeAllRanges(),d=0);this.nativeSelection.addRange(g(b));this.rangeCount=this.nativeSelection.rangeCount;this.rangeCount==d+1?(a.config.checkSelectionRanges&&(d=E(this.nativeSelection,
this.rangeCount-1))&&!v.rangesEqual(d,b)&&(b=new t(d)),this._ranges[this.rangeCount-1]=b,e(this,b,K(this.nativeSelection)),this.isCollapsed=F(this)):this.refresh()}}:function(a,b){b&&M?n(this,a):(this.nativeSelection.addRange(g(a)),this.refresh())};w.setRanges=function(a){if(H&&1<a.length)u(this,a);else{this.removeAllRanges();for(var b=0,c=a.length;b<c;++b)this.addRange(a[b])}}}else if(s.isHostMethod(y,"empty")&&s.isHostMethod(O,"select")&&H&&J)w.removeAllRanges=function(){try{if(this.docSelection.empty(),
...
return!0}};var G=function(a,b){var c=a.getAllRanges(),d=!1;a.removeAllRanges();for(var e=0,h=c.length;e<h;++e)d||b!==c[e]?a.addRange(c[e]):d=!0;a.rangeCount||f(a)};w.removeRange=H?function(a){if("Control"==this.docSelection.type){var b=this.docSelection.createRange();a=k(a);for(var c=r.getDocument(b.item(0)),c=r.getBody(c).createControlRange(),d,e=!1,h=0,f=b.length;h<f;++h)d=b.item(h),d!==a||e?c.add(b.item(h)):e=!0;c.select();l(this)}else G(this,a)}:function(a){G(this,a)};var K;!J&&I&&a.features.implementsDomRange?
...
wysihtml5.dom.getParentElement=function(){function a(a,b){return b&&b.length?"string"===typeof b?a===b:wysihtml5.lang.array(b).contains(a):!0}return function(c,b,d){d=d||50;if(b.className||b.classRegExp){a:{var e=b.nodeName,f=b.className;for(b=b.classRegExp;d--&&c&&"BODY"!==c.nodeName;){var g;if(g=c.nodeType===wysihtml5.ELEMENT_NODE&&a(c.nodeName,e)){g=f;var k=(c.className||"").match(b)||[];g=g?k[k.length-1]===g:!!k.length}if(g)break a;c=c.parentNode}c=null}return c}a:{e=b.nodeName;for(f=d;f--&&c&&
...
(h="div"));if(h in f){b=f[h];if(!b||b.remove)return null;b="string"===typeof b?{rename_tag:b}:b}else if(a.firstChild)b={rename_tag:d};else return null;h=a.ownerDocument.createElement(b.rename_tag||h);var f={},k=b.set_class,s=b.add_class,v=b.set_attributes,t=b.check_attributes,x=g.classes,B=0,A=[];b=[];var F=[],y=[],C;v&&(f=wysihtml5.lang.object(v).clone());if(t)for(C in t)if(v=l[t[C]])v=v(c(a,C)),"string"===typeof v&&(f[C]=v);k&&A.push(k);if(s)for(C in s)if(v=p[s[C]])k=v(c(a,C)),"string"===typeof k&&
...
(function(a){function c(b){return"block"===a.getStyle("display").from(b)}function b(a){var b=a.ownerDocument.createElement("br");a.appendChild(b)}a.resolveList=function(a,e){if(a.nodeName.match(/^(MENU|UL|OL)$/)){var f=a.ownerDocument,g=f.createDocumentFragment(),k=a.previousElementSibling||a.previousSibling,h,l;if(e)for(k&&!c(k)&&b(g);l=a.firstElementChild||a.firstChild;){for(f=l.lastChild;k=l.firstChild;)h=(h=k===f)&&!c(k)&&"BR"!==k.nodeName,g.appendChild(k),h&&b(g);l.parentNode.removeChild(l)}else for(;l=
a.firstElementChild||a.firstChild;){if(l.querySelector&&l.querySelector("div, p, ul, ol, menu, blockquote, h1, h2, h3, h4, h5, h6"))for(;k=l.firstChild;)g.appendChild(k);else{for(h=f.createElement("p");k=l.firstChild;)h.appendChild(k);g.appendChild(h)}l.parentNode.removeChild(l)}a.parentNode.replaceChild(g,a)}}})(wysihtml5.dom);
...
a.ELEMENT_NODE&&c.dom.arrayContains(this.tagNames,b.tagName.toLowerCase())&&d)return b;b=b.parentNode}return!1},postApply:function(a,b){for(var c=a[0],d=a[a.length-1],f=[],g,k=c,r=d,s=0,v=d.length,t,x,B=0,A=a.length;B<A;++B)t=a[B],(x=this.getAdjacentMergeableTextNode(t.parentNode,!1))?(g||(g=new e(x),f.push(g)),g.textNodes.push(t),t===c&&(k=g.firstTextNode,s=k.length),t===d&&(r=g.firstTextNode,v=g.getLength())):g=null;if(c=this.getAdjacentMergeableTextNode(d.parentNode,!0))g||(g=new e(d),f.push(g)),
...
c){var b=wysihtml5.commands[a],d=wysihtml5.lang.array(arguments).get(),e=b&&b.state;if(e)return d.unshift(this.composer),e.apply(b,d);try{return this.doc.queryCommandState(a)}catch(f){return!1}}});
(function(a){var c=/(align-(left|center|right)|justify)/g;a.commands.alignment={exec:function(b,d,e){return"justify"===e?a.commands.formatInline.exec(b,d,"div","justify",c):a.commands.formatInline.exec(b,d,"div","align-"+e,c)},state:function(b,d,e){return"justify"===e?a.commands.formatInline.state(b,d,"div","justify",c):a.commands.formatInline.state(b,d,"div","align-"+e,c)}}})(wysihtml5);
(function(a){var c=/wysiwyg-background-color-[a-z0-9\-]+/g;a.commands.backgroundColor={exec:function(a,d,e,f){d="wysiwyg-background-color-"+e.replace("#","");var g=document.createElement("style"),k=editor.composer.doc.body,h=k.classList;g.type="text/css";g.innerHTML="."+d+" { background-color: "+e+" !important; }";a.iframe.contentDocument.getElementsByTagName("head")[0].appendChild(g);for(a=0;a<h.length;a++)h[a].match(c)&&k.classList.remove(h[a]);for(a=0;a<f.length;a++)k.setAttribute(f[a].name,f[a].value);
k.classList.add(d)},state:function(a,c,e,f){}}})(wysihtml5);wysihtml5.commands.bold={exec:function(a,c){return wysihtml5.commands.formatInline.exec(a,c,"b")},state:function(a,c){return wysihtml5.commands.formatInline.state(a,c,"b")}};wysihtml5.commands.clear={exec:function(a,c){a.doc.body.innerHTML=""},state:function(a,c){}};
(function(a){function c(c,g){var k=c.doc,h="_wysihtml5-temp-"+ +new Date,l=0,p,m,u;a.commands.formatInline.exec(c,b,d,h,/non-matching-class/g);p=k.querySelectorAll(d+"."+h);for(h=p.length;l<h;l++)for(u in m=p[l],m.removeAttribute("class"),g)m.setAttribute(u,g[u]);l=m;1===h&&(u=e.getTextContent(m),h=!!m.querySelector("*"),u=""===u||u===a.INVISIBLE_SPACE,!h&&u&&(e.setTextContent(m,g.text||m.href),k=k.createTextNode(" "),c.selection.setAfter(m),e.insert(k).after(m),l=k));c.selection.setAfter(l)}var b,
...
(function(a){var c=/wysiwyg-font-family-[a-z\-]+/g;a.commands.customFont={exec:function(b,d,e,f){var g="wysiwyg-font-family-"+e.replace(/ /g,"-").toLowerCase(),k=document.createElement("style");k.type="text/css";k.innerHTML="."+g+" { font-family: '"+e+"', serif; }";b.iframe.contentDocument.getElementsByTagName("head")[0].appendChild(k);return a.commands.formatInline.exec(b,d,"span",g,c,f)},state:function(b,d,e,f){e="wysiwyg-font-family-"+e.replace(/ /g,"-").toLowerCase();return a.commands.formatInline.state(b,
d,"span",e,c,f)}}})(wysihtml5);(function(a){var c=/wysiwyg-font-size-[0-9a-z\-]+/g;a.commands.fontSize={exec:function(b,d,e){return a.commands.formatInline.exec(b,d,"span","wysiwyg-font-size-"+e,c)},state:function(b,d,e){return a.commands.formatInline.state(b,d,"span","wysiwyg-font-size-"+e,c)}}})(wysihtml5);
...
(function(a){function c(c,f,g,k){var h=c+":"+f;if(!d[h]){var l=d,p=a.selection.HTMLApplier,m=b[c];c=m?[c.toLowerCase(),m.toLowerCase()]:[c.toLowerCase()];l[h]=new p(c,f,g,!0,k)}return d[h]}var b={strong:"b",em:"i",b:"strong",i:"em"},d={};a.commands.formatInline={exec:function(a,b,d,k,h,l){b=a.selection.getRange();if(!b)return!1;c(d,k,h,l).toggleRange(b);a.selection.setSelection(b)},state:function(d,f,g,k,h,l){f=d.doc;var p=b[g]||g;return!a.dom.hasElementWithTagName(f,g)&&!a.dom.hasElementWithTagName(f,
p)||k&&!a.dom.hasElementWithClassName(f,k)?!1:(d=d.selection.getRange())?c(g,k,h,l).isAppliedToRange(d):!1}}})(wysihtml5);
(function(a){var c=/wysiwyg-font-family-[a-z\-]+/g;a.commands.googleFont={exec:function(b,d,e,f){var g="wysiwyg-font-family-"+e.replace(/ /g,"-").toLowerCase(),k=document.createElement("style");k.type="text/css";k.innerHTML="."+g+" { font-family: '"+e+"', serif; }";b.iframe.contentDocument.getElementsByTagName("head")[0].appendChild(k);return a.commands.formatInline.exec(b,d,"span",g,c,f)},state:function(b,d,e,f){e="wysiwyg-font-family-"+e.replace(/ /g,"-").toLowerCase();return a.commands.formatInline.state(b,
d,"span",e,c,f)}}})(wysihtml5);
(function(a){var c=/wysiwyg-highlight-color-[a-z0-9\-]+/g;a.commands.highlightColor={exec:function(b,d,e,f){var g="wysiwyg-highlight-color-"+e.replace("#",""),k=document.createElement("style");k.type="text/css";k.innerHTML="."+g+" { background-color: "+e+"; }";b.iframe.contentDocument.getElementsByTagName("head")[0].appendChild(k);return a.commands.formatInline.exec(b,d,"span",g,c,f)},state:function(b,d,e,f){e="wysiwyg-highlight-color-"+e.replace("#","");return a.commands.formatInline.state(b,d,"span",
e,c,f)}}})(wysihtml5);wysihtml5.commands.insertHTML={exec:function(a,c,b){a.commands.support(c)?a.doc.execCommand(c,!1,b):a.selection.insertHTML(b)},state:function(){return!1}};
...
(function(a){var c=/wysiwyg-text-align-[0-9a-z]+/g;a.commands.justifyFull={exec:function(b,d){return a.commands.formatBlock.exec(b,"formatBlock",null,"wysiwyg-text-align-justify",c)},state:function(b,d){return a.commands.formatBlock.state(b,"formatBlock",null,"wysiwyg-text-align-justify",c)}}})(wysihtml5);
(function(a){var c=/wysiwyg-line-height-[0-9\-]+/g;a.commands.lineHeight={exec:function(b,d,e){return a.commands.formatInline.exec(b,d,"span","wysiwyg-line-height-"+e,c)},state:function(b,d,e){return a.commands.formatInline.state(b,d,"span","wysiwyg-line-height-"+e,c)}}})(wysihtml5);wysihtml5.commands.redo={exec:function(a){return a.undoManager.redo()},state:function(a){return!1}};
(function(a){var c=/wysiwyg-font-family-[a-z\-]+/g;a.commands.standardFont={exec:function(b,d,e,f,g){e="wysiwyg-font-family-"+e.replace(/ /g,"-").toLowerCase();var k=document.createElement("style");k.type="text/css";k.innerHTML="."+e+" { font-family: "+f+"; }";b.iframe.contentDocument.getElementsByTagName("head")[0].appendChild(k);return a.commands.formatInline.exec(b,d,"span",e,c,g)},state:function(b,d,e,f,g){e="wysiwyg-font-family-"+e.replace(/ /g,"-").toLowerCase();return a.commands.formatInline.state(b,
d,"span",e,c,g)}}})(wysihtml5);
(function(a){var c=/wysiwyg-text-color-[a-z0-9\-]+/g;a.commands.textColor={exec:function(b,d,e,f){var g="wysiwyg-text-color-"+e.replace("#",""),k=document.createElement("style");k.type="text/css";k.innerHTML="."+g+" { color: "+e+"; }";b.iframe.contentDocument.getElementsByTagName("head")[0].appendChild(k);return a.commands.formatInline.exec(b,d,"span",g,c,f)},state:function(b,d,e,f){e="wysiwyg-text-color-"+e.replace("#","");return a.commands.formatInline.state(b,d,"span",e,c,f)}}})(wysihtml5);
